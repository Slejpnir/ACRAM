...
if env=="nokia17"
    subjects(1)=struct("RAL", 1,"mPA", 1,"ALD", 1,"MPA", 1,"EPH", 1,"ALT", 1,"MPL", 1,"PCR", 1,"SPE", 1,"SAB","Low");
    subjects(2)=struct("RAL", 0,"mPA", 0,"ALD", 0,"MPA", 1,"EPH", 1,"ALT", 0,"MPL", 0,"PCR", 1,"SPE", 0,"SAB","Medium");
    subjects(3)=struct("RAL", 0,"mPA", 0,"ALD", 0,"MPA", 1,"EPH", 1,"ALT", 0,"MPL", 1,"PCR", 0,"SPE", 0,"SAB","High");
    ...
    objects(1)=	struct("Name", "Draytek Vigor 2860Ln Router","OVL", "Critical","OAF", "Constantly","ISL", "High","LOD", "Low","LOI", "Low","OVLP",[1],"S","Negligible","OAB","Low");
    objects(2)=	struct("Name", "16 Port Switch Netgear GS116E","OVL", "High","OAF", "Constantly","ISL", "High","LOD", "Low","LOI", "High","OVLP",[2],"S","Negligible","OAB","Low");
    objects(3)=	struct("Name", "16 Port Switch","OVL", "High","OAF", "Constantly","ISL", "High","LOD", "Low","LOI", "High","OVLP",[2],"S","Negligible","OAB","Low");
    objects(4)=	struct("Name", "ABB Robot","OVL", "High","OAF", "Often","ISL", "Medium","LOD", "Medium","LOI", "Low","OVLP",[2],"S","Marginal","OAB","High");
    objects(5)=	struct("Name", "PC 1 Left TV","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(6)=	struct("Name", "PC 2 Right TV","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(7)=	struct("Name", "PC 3","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(8)=	struct("Name", "Ubiquity WiFi SSID-1 Nokia/Fiab","OVL", "High","OAF", "Constantly","ISL", "High","LOD", "Low","LOI", "High","OVLP",[2],"S","Negligible","OAB","Low");
    objects(9)=	struct("Name", "Tablet 1","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(10)=	struct("Name", "Tablet 2","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(11)=	struct("Name", "Double robotics","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(12)=	struct("Name", "IP Camera","OVL", "None","OAF", "Constantly","ISL", "High","LOD", "Medium","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(13)=	struct("Name", "Google ML Board","OVL", "None","OAF", "Constantly","ISL", "High","LOD", "Low","LOI", "Low","OVLP",[],"S","Negligible","OAB","Low");
    objects(14)=	struct("Name", "MES","OVL", "None","OAF", "Constantly","ISL", "High","LOD", "Medium","LOI", "Medium","OVLP",[],"S","Negligible","OAB","Low");
    objects(15)=	struct("Name", "5G Network","OVL", "None","OAF", "Constantly","ISL", "High","LOD", "Low","LOI", "Medium","OVLP",[],"S","Negligible","OAB","Low");
    objects(16)=	struct("Name", "3D Printer","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "High","LOI", "Low","OVLP",[3],"S","Negligible","OAB","Low");
    objects(17)=	struct("Name", "VPN SERVER","OVL", "None","OAF", "Rarely","ISL", "Low","LOD", "High","LOI", "Low","OVLP",[3],"S","Negligible","OAB","Low");
    ...
    ACL(1,4)={struct("Permission", "P","SCA", "AAL-3")};
    ...
    ACL(1,1)={struct("Permission", "P","SCA", "AAL-1")};
    ACL(1,2)={struct("Permission", "P","SCA", "AAL-2")};
    ACL(1,3)={struct("Permission", "P","SCA", "AAL-1")};
    ACL(1,5)={struct("Permission", "P","SCA", "AAL-3")};
    ACL(1,7)={struct("Permission", "P","SCA", "AAL-1")};
    ACL(1,11)={struct("Permission", "R","SCA", "AAL-1")};
    ACL(1,14)={struct("Permission", "P","SCA", "AAL-3")};
    ACL(1,17)={struct("Permission", "P","SCA", "AAL-1")};
    
    ACL(2,3)={struct("Permission", "E","SCA", "AAL-1")};
    ACL(2,7)={struct("Permission", "R","SCA", "AAL-3")};
    ACL(2,9)={struct("Permission", "E","SCA", "AAL-2")};
    
    ACL(2,13)={struct("Permission", "E","SCA", "AAL-3")};
    ACL(2,15)={struct("Permission", "E","SCA", "AAL-2")};
    
    ACL(3,4)={struct("Permission", "R","SCA", "AAL-3")};
    ACL(3,5)={struct("Permission", "E","SCA", "AAL-2")};
    ACL(3,6)={struct("Permission", "P","SCA", "AAL-1")};
    ACL(3,8)={struct("Permission", "P","SCA", "AAL-3")};
    ACL(3,10)={struct("Permission", "R","SCA", "AAL-2")};
    ACL(3,12)={struct("Permission", "E","SCA", "AAL-3")};
    ACL(3,16)={struct("Permission", "R","SCA", "AAL-1")};
    networkFileName="network_nokia17.xml";
    OAFFilename="nokia_OAF.csv";
    SABFileName="nokia_SAB.csv";
end
OAFArray=0:0.05:1;
ISLArray=0:0.05:1;
AS=zeros(length(ISLArray),length(OAFArray));
...
for object=1:nObjects
    if LOIinput=="zabbix"
        objects(object).LOI=pageRanks(find(objectsNamesZabbix==objects(object).Name));
    ...
    for j=1:length(OAFArray)
        if isstruct(ACL{user,object})
            ...
            %%}
                ...
                switch objects(object).OAB
                    case "Low"
                        testInputParameters("OAB")=0;
                    case "Medium"
                        testInputParameters("OAB")=0.5;
                    case "High"
                        testInputParameters("OAB")=1;
                end
                ...
                % SAB: allow numeric [0,1] or legacy strings
                try
                    sab_raw = subjects(user).SAB;
                    if isnumeric(sab_raw)
                        testInputParameters("SAB") = max(0, min(1, sab_raw));
                    else
                        switch string(sab_raw)
                            case "Low"
                                testInputParameters("SAB") = 0.2;
                            case "Medium"
                                testInputParameters("SAB") = 0.5;
                            case "High"
                                testInputParameters("SAB") = 0.8;
                            otherwise
                ...
                for vulnerability=1:nVulnerability
                    if ~isempty(objects(object).OVLP)
                        ...
                        %disp(OVLP(objects(object).OVLP(vulnerability)).AV);
                        ...
                        switch OVLP(objects(object).OVLP(vulnerability)).UI
                            case "NOT DEFINED"
                                testInputParameters("UI")=0.12;                                
                            case "NONE"
                                testInputParameters("UI")=0.37;
                            case "PASSIVE"
                                testInputParameters("UI")=0.62;
                            case "ACTIVE"
                                testInputParameters("UI")=0.87;
                            case "REQUIRED"
                                testInputParameters("UI")=0.87;
                        end
                    else
                        ...
                        testInputParameters("VA")=0;
                        testInputParameters("VI")=0;
                        testInputParameters("UI")=0;
                    end
                    [RiskLevel(vulnerability), intermediateNodes{vulnerability}]=EvaluateRisk(testInputParameters,LOIMethod);
                    intermediateNodesGlobal{user,object,vulnerability}=intermediateNodes{vulnerability};
                    testInputParametersGlobal{user,object,vulnerability}=testInputParameters;
                end
                
                [Risks(user,object), ii]=max(RiskLevel);
                AS(i,j)=intermediateNodes{ii}("AS");
                %graphArray{user,object}=graphArrayOne{i};
                %if user==1 && object==1
                    %fig1 = uifigure('Position', [100 100 1200 800]);
                    %ax = uiaxes(fig1,'Position', [20 20 1100 750]);
                if gui=="on"
                    graphArray{user,object}=createGraph(SPMP,SPMPNames,testInputParameters,intermediateNodes{ii},RiskLevel(ii),LOIMethod);
                end
