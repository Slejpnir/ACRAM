...
class Transaction:
    ...
    @staticmethod
    def make_create_blob_transaction(context_id, file_stream, mime_type, auth_user_id, auth_user_public_key, dataspace_id=None):
    ...
    @staticmethod
    def make_create_context_transaction(name, description, context_data, context_metadata, mammocks, version, read_permissions, write_permissions, auth_user_id, auth_user_public_key, dataspace_id=None):
        data = {}
        if context_data:
    ...
    @staticmethod
    def make_create_index_transaction(fields, auth_user_id, auth_user_public_key, dataspace_id=None):
        transaction = {
            'data': {
                'fields': fields
            },
    ...
    @staticmethod
    def make_create_transaction(context_id, data, metadata, auth_user_id, auth_user_public_key, dataspace_id=None):
        transaction = {
    ...
    @staticmethod
    def make_create_user_transaction(name, public_key, users_admin, contexts_admin, auth_user_id, auth_user_public_key, dataspace_id=None):
        metadata = {
            'name': name
        }
        if public_key:
    ...
    @staticmethod
    def make_update_blob_transaction(asset_id, input_id, context_id, auth_user_id, auth_user_public_key, dataspace_id=None):
        transaction = {
            'asset_id': asset_id,
            'input_id': input_id,
            'metadata': {
    ...
    @staticmethod
    def make_update_context_transaction(asset_id, input_id, name, description, read_permissions, write_permissions, auth_user_id, auth_user_public_key, dataspace_id=None):
        transaction = {
            'asset_id': asset_id,
            'input_id': input_id,
            'metadata': {
    ...
    @staticmethod
    def make_update_index_transaction(asset_id, input_id, action, auth_user_id, auth_user_public_key, dataspace_id=None):
        transaction = {
            'asset_id': asset_id,
            'input_id': input_id,
            'metadata': {
    ...
    @staticmethod
    def make_update_transaction(asset_id, input_id, context_id, metadata, auth_user_id, auth_user_public_key, dataspace_id=None):
        transaction = {
            'asset_id': asset_id,
            'input_id': input_id,
            'context_id': context_id,
    ...
    @staticmethod
    def make_update_user_transaction(asset_id, input_id, name, public_key, users_admin, contexts_admin, auth_user_id, auth_user_public_key, dataspace_id=None):
        metadata = {
            'name': name
        }
        if public_key:
